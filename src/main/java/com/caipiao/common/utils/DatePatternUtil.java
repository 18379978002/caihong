...
public class DatePatternUtil {
    ...
    /** 格式匹配模式 */
    public static final Pattern PATTERN1 = Pattern.compile("\\d{4}");

    /** 格式匹配模式 */
    public static final Pattern PATTERN2 = Pattern.compile("\\d{4}-\\d{1,2}");

    /** 格式匹配模式 */
    public static final Pattern PATTERN3 = Pattern.compile("(\\d{4}\\-\\d{1,2}\\-\\d{1,2})");

    /** 格式匹配模式 */
    public static final Pattern PATTERN4 = Pattern.compile("(\\d{4}\\-\\d{1,2}\\-\\d{1,2} \\d{1,2}:\\d{1,2})");

    /** 格式匹配模式 */
    public static final Pattern PATTERN5 = Pattern.compile("\\d{4}-\\d{1,2}-\\d{1,2}\\s\\d{1,2}:\\d{1,2}:\\d{1,2}");

    /** 格式匹配模式 */
    public static final Pattern PATTERN6 = Pattern
            .compile("\\d{4}-\\d{1,2}-\\d{1,2}\\s\\d{1,2}:\\d{1,2}:\\d{1,2}\\.\\d+");

    /** 格式匹配模式 */
    public static final Pattern PATTERN7 = Pattern.compile("\\d{4}/\\d{1,2}/\\d{1,2}");

    /** 格式匹配模式 */
    public static final Pattern PATTERN8 = Pattern
            .compile("\\w{3}\\s\\w{3}\\s\\d{1,2}\\s\\d{4}\\s\\d{1,2}:\\d{1,2}:\\d{1,2}\\sGMT\\+0800");

    /** 格式匹配模式 */
    public static final Pattern PATTERN9 = Pattern.compile("\\d{4}\\d{1,2}");

    /** 格式匹配模式 */
    public static final Pattern PATTERN10 = Pattern.compile("(\\d{4}\\d{1,2}\\d{1,2})");
     ...
     * @return
     */
    public static Boolean getMatchFormat(final String value, Pattern pattern){
        Matcher matcher = pattern.matcher(value);
