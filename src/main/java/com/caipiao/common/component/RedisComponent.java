package com.caipiao.common.component;
...
public class RedisComponent {
    ...
    /*public List<RankDO> getTopNRanks(String key,int n) {
        Set<ZSetOperations.TypedTuple<Object>> result = this.rangeWithScore(key, 0, n - 1);
    ...
    private List<RankDO> buildRedisRankToBizDO(Set<ZSetOperations.TypedTuple<Object>> result, long offset) {
        ...
        for (ZSetOperations.TypedTuple<Object> sub : result) {
            rankList.add(new RankDO(rank++, Math.abs(sub.getScore().floatValue()), (Long) sub.getValue()));
        }
        return rankList;
    }*/
